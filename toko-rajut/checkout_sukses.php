...
<section class="section">
  <div class="checkout-sukses-wrap">
    ...
    <p class="checkout-note checkout-sukses-note">Simpan kode pesanan di atas untuk melihat detail pesanan. Admin Lalunaco akan menghubungi Anda melalui WhatsApp terkait informasi dan proses pengiriman pesanan.</p>
    ...
    <div class="checkout-sukses-actions">
      ...
      <div class="checkout-sukses-row">
        <a href="invoice.php?kode=<?= urlencode($transaksi['kode']) ?>" target="_blank" class="btn btn-outline">🖨 Cetak Invoice</a>
        <a href="produk.php" class="btn btn-primary">Lanjut Belanja</a>
      </div>
      <a href="index.php" class="checkout-sukses-beranda">Kembali ke Beranda</a>
    </div>
  </div>
</section>
