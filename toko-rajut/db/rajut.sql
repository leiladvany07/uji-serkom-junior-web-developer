-- Skema database Toko Rajut "Rajutan Bu Sri" (VERSI MYSQL)
-- Import file ini melalui phpMyAdmin (XAMPP/Laragon) sebelum menjalankan aplikasi.
-- Jika memakai PostgreSQL + pgAdmin, pakai file db/rajut_postgres.sql, BUKAN file ini.
-- config.php pada proyek ini sudah diatur untuk PostgreSQL secara default.

CREATE DATABASE IF NOT EXISTS toko_rajut CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE toko_rajut;
